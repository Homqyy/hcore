...
hcore_astring_t *hcore_create_astring(size_t size, astr_realloc_pt astr_realloc, astr_free_pt astr_free);
hcore_int_t hcore_init_astring(hcore_astring_t *astr, size_t size, astr_realloc_pt astr_realloc, astr_free_pt astr_free);
