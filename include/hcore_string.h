...
#define hcore_movemem(dst, src, n) (((hcore_uchar_t *)memmove(dst, src, n)) + (n))
 ...
 * @retval
 */
hcore_uchar_t *hcore_vslprintf(hcore_uchar_t *buf, hcore_uchar_t *last, const char *fmt,
                           va_list args);
hcore_uchar_t *hcore_slprintf(hcore_uchar_t *buf, hcore_uchar_t *last, const char *fmt,
                          ...);
hcore_uchar_t *hcore_hex_dump(hcore_uchar_t *dst, hcore_uchar_t *src, size_t len);
