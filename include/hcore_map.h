...
hcore_int_t  hcore_init_map(hcore_map_t *map, hcore_pool_t *pool,
                            hcore_uint_t size);
hcore_int_t  hcore_map_set(hcore_map_t *map, hcore_uint_t pos);
hcore_int_t  hcore_map_set_range(hcore_map_t *map, hcore_uint_t bp,
                                 hcore_uint_t ep);
hcore_int_t  hcore_map_unset(hcore_map_t *map, hcore_uint_t pos);
hcore_int_t  hcore_map_unset_range(hcore_map_t *map, hcore_uint_t bp,
                                   hcore_uint_t ep);
